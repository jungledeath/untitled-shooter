...
// 3. CHECK FOR A PHYSICAL GAMEPAD
var _gamepad_connected = false;
// GameMaker supports up to 12 controller slots (0 through 11)
for (var i = 0; i < 12; i++) 
{
...
// 4. GET RIGHT STICK INPUT (Aiming)
...
// STATE 1: MANUALLY AIMING (Gamepad Active)
if (abs(_aim_x) > 0.3 || abs(_aim_y) > 0.3)
{
    ...
    // Continuous fire as long as the stick is pushed
    if (fire_timer <= 0)
    {
...
else
{
    ...
    {
        // GAMEPAD MODE: The player let go of the stick. Cease fire!
        image_angle = oPlayer.direction; 
    }
    else
    {
        // TOUCH SCREEN MODE: No controller detected. Run the Auto-Aim AI!
        ...
        with (pTarget)
        {
            ...
            {
                // Bottom turret Threat AI: Heavy damage and HP focus
