...
{
    // ---> THE FREEZE CHECK <---
    // Only tick the timer and spawn enemies if the freeze powerup is inactive
    if (global.freeze_timer <= 0) 
    {
        ...
        else
        {
            ...
            // Pick a random distance between 0 and 20 pixels away
            var _dist = irandom_range(0, 20); 
